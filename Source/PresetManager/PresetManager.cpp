...
const juce::File PresetManager::defaultPresetDirectory{
    juce::File::getSpecialLocation(
        ...
        .getChildFile("CraftLabs Mayerism")
...
PresetManager::PresetManager(juce::AudioProcessorValueTreeState &apvts)
  ...
  currentPreset.referTo(
      apvts.state.getPropertyAsValue(presetNameProperty, nullptr));
}
...
int PresetManager::loadNextPreset() {
  ...
  // loadPreset(allPresets.getReference(nextIndex)); //This will work on
  // JUCE 6.1.5
...
int PresetManager::loadPreviousPreset() {
  ...
  // loadPreset(allPresets.getReference(previousIndex)); //This will work on
  // JUCE 6.1.5
...
void PresetManager::valueTreeRedirected(juce::ValueTree &treeChanged) {
  currentPreset.referTo(
      treeChanged.getPropertyAsValue(presetNameProperty, nullptr));
}